if(style >= 0 && sprite_exists(style))
{
	...
	else
	{
		...
		//centro
		draw_sprite_ext(style,3,x + wspr,y + hspr,(width - wspr*2)/wspr,(height - hspr*2)/hspr,0,c_white,1);
...
else
{
	if(!clicked)
	{
		...
		draw_rectangle(x - 1, y, x + width - 1, y + height - 2, 0);
		draw_set_color(c_dkgray);
		draw_rectangle(x - 1, y, x + width - 1, y + height - 2, 1);
	}
	else
	{
